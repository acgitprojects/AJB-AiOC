...
import { PIPELINE_ITEMS, type PipelineItem } from "@/lib/mock-data";
    ...
    <div className="p-4 lg:p-6 max-w-screen-xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3 animate-fade-in">
        {pipelineStages.map(stage => {
          const items  = PIPELINE_ITEMS.filter(p => p.stage === stage);
          ...
          return (
            ...
            >
              ...
              <div className="p-2 space-y-2">
                {items.length === 0 && <p className="text-slate-700 text-xs p-1">—</p>}
                {items.map(p => (
                  <div
                    key={p.id}
